  ...
  update() {
    ...
    let isSameNode = (oldNode, newNode) => {
      ...
      if (newNode.type === '#text') {
        if (newNode.conetnt !== oldNode.conetnt) {
          return false
        }
      }
      return true
...
class TextWrapper extends Component {
  ...
  [RENDER_TO_DOM](range) {
    this._range = range
    let root = document.createTextNode(this.conetnt)
    replaceConetnt(range, root)
  }

}
  function replaceConetnt(range, node) {
